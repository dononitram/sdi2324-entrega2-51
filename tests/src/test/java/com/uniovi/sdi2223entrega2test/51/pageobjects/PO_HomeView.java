...
public class PO_HomeView extends PO_NavView {
    ...
    public static void checkAccessDeniedMessage(WebDriver driver, int language) {
        SeleniumUtils.waitLoadElementsBy(driver, "text", p.getString("Error.access.denied", language), getTimeout());
    }
